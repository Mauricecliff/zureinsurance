...
function FAQ() {
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-6">
            ...
            <p className="text-gray-600">
                Yes! From quotes to claims, everything can be done online. But if you need to speak with someone, our friendly support team is always just a call or chat away.
            </p>
            </div>
             <div className="bg-white p-6 rounded-xl shadow-lg">
            <h3 className="text-lg font-semibold text-gray-900 mb-3">
                Is ZureInsurance licensed and legitimate?
            </h3>
            <p className="text-gray-600">
                Yes. We are a registered and compliant insurance provider operating under all legal regulations, and we work with trusted partners and underwriters to bring you solid, secure coverage.
            </p>
            </div>
        </div>
        <div className="space-y-6">
            ...
            <p className="text-gray-600">
                Filing a claim is simple. Log into your dashboard, click “File a Claim,” and follow the steps. You can also reach out to our support team if you need help.
            </p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-lg">
            <h3 className="text-lg font-semibold text-gray-900 mb-3">
